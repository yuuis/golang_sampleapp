 ...
 */ 
func GetByPKMIshiguro(sid string, r *http.Request) (autodbdto.DBMIshiguroDTO, bool, bool) { 
	db := db.DbConn() 
 
	sql := "select * from m_ishiguro where sid = ? "
	stmt, err := db.Prepare(sql) 
	if err != nil { 
		common.WriteErrorLog(config.FATAL, err, r) 
		var rv autodbdto.DBMIshiguroDTO 
	...
	defer rows.Close() 
	for rows.Next() { 
		var columns autodbdto.DBMIshiguroDTO 
	...
	var rdto autodbdto.DBMIshiguroDTO 
 ...
 * 取得できなかった場合は空の構造体とfalseを返す 
 */ 
func GetByPKMIshiguroForUpdate(db *sql.Tx, sid string, r *http.Request) (autodbdto.DBMIshiguroDTO, bool, bool) { 
 ...
 * 取得できなかった場合は空の配列を返す 
 */ 
func SelectByInMIshiguro(targetColumn string, in []string, r *http.Request) ([]autodbdto.DBMIshiguroDTO, bool) { 
	var rdto []autodbdto.DBMIshiguroDTO 
	...
	sql := "select * from m_ishiguro where " + targetColumn + " in (" 
	where := "" 
	for ind, _ := range in { 
		if where != "" { 
			where = where + "," 
 ...
 * 取得できなかった場合は空の配列を返す 
 */ 
func SelectByInMIshiguroForUpdate(db *sql.Tx, targetColumn string, in []string, r *http.Request) ([]autodbdto.DBMIshiguroDTO, bool) { 
	var rdto []autodbdto.DBMIshiguroDTO 
 ...
 * 取得できなかった場合は、空の配列を返す 
 */ 
func SelectMIshiguro(search *autodbdto.DBMIshiguroForm, r *http.Request) ([]autodbdto.DBMIshiguroDTO, bool) { 
	var rdto []autodbdto.DBMIshiguroDTO 
 ...
 * 成功時には追加したIDを返す 
 */ 
func InsertMIshiguro(db *sql.Tx, search *autodbdto.DBMIshiguroForm, r *http.Request, excludes []string) (int64, bool) { 
	columnSql := "" 
	valueSql := "" 
	var arr []string 
	columns := []string{ 
 ...
 * 除外したいカラムはexcludesへ配列で格納する 
 */ 
func UpdateMIshiguro(db *sql.Tx, search *autodbdto.DBMIshiguroForm, r *http.Request, excludes []string) bool { 
	columnSql := "" 
	var arr []string 
	columns := []string{ 
		"sid", 
 ...
 * バルクインサート 
 */ 
func BulkInsertMIshiguro(db *sql.Tx, search []*autodbdto.DBMIshiguroForm, r *http.Request, excludes []string) (int64, bool) { 
	columnSql := "" 
	valueSql := "" 
	var arr []string 
	columns := []string{ 
	...
	for dataInd, _ := range search { 
		...
		for ind, _ := range columns { 
			if IsColumnExcludes(columns[ind], excludes) == false { 
				...
				case 2: 
					arr = append(arr, search[dataInd].Code) 
				case 3: 
 ...
 * バルクアップデート 
 */ 
func BulkUpdateMIshiguro(db *sql.Tx, search []*autodbdto.DBMIshiguroForm, r *http.Request, excludes []string) (int64, bool) { 
	columnSql := "" 
	valueSql := "" 
	duplicateKeys := "" 
